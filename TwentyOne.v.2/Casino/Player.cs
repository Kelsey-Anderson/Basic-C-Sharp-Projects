...
namespace Casino
{
    ...
    {
        public Player(string name) : this(name, 100) // assign name to name, but if they don't give beginning balacne, defaul 100 beginning balance
        {
            //this area can be empty, no implementation necessary, it's reusing code from other constructor
        }
